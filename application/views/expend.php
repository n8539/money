		  ...
		  <div class="navbar-inner">
			...
			<div class="nav-collapse collapse">  
				<ul class="nav">
				  ...
				  <li id="zc"  class="active"><a href="<?php echo site_url();?>epay/expend">支出</a></li>
				  <li class="divider-vertical"></li>
				  <li id="sl"><a href="<?php echo site_url();?>epay/income">收入</a></li>
				  <li class="divider-vertical"></li> 
			...
			<form class="form-signin">
			  <fieldset>
				...
				<label>类别-- <b><span id="class_value"></span></b></label>
					...
					<div class="btn-group" id="class_sel">
